                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<?php echo url("admin/products/update", ['id' => $id]) ?>" method="POST" enctype="multipart/form-data" style="text-align:center">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" step="0.1" class="form-control" id="rate" name="rate" value="<?php echo $product->rate ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" step="0.1" class="form-control" id="weight" name="weight" value="<?php echo $product->weight ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
